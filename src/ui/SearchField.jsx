...
const SearchField = ({ onSearchQuery }) => {
  return (
    <div className="relative flex max-w-[450px] items-center rounded-md bg-neutral-very-light-gray-bg drop-shadow-md dark:bg-neutral-dark-blue-elements dark:text-neutral-white-text-elements dark:placeholder:text-gray-200">
